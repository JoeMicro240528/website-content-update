    ...
    return (
        <div className="min-h-screen bg-white" dir="rtl">
            ...
            <div className="sr-only" aria-hidden="true">
                نظام استدعاء الممرضات, Nurse Call System Egypt, نظام نداء الممرضات, مستشفيات مصر
            </div>
                ...
                <div className="container mx-auto px-4 py-3">
                    <div className="flex items-center justify-between">
                        ...
                        <nav className="hidden md:flex items-center bg-gray-100 rounded-full px-2 py-1.5 gap-1">
                            ...
                            <Link href="/nurse-call-system" className="text-xs font-semibold px-4 py-2 rounded-full bg-red-600 text-white shadow-sm transition-all">
                                استدعاء الممرضات
                            </Link>
                    ...
                    {isMenuOpen && (
                        <nav className="md:hidden mt-3 flex flex-col gap-1 pb-3 border-t border-gray-100 pt-3">
                            ...
                            <Link href="/nurse-call-system" className="text-sm font-semibold px-4 py-2.5 rounded-xl bg-red-600 text-white">
                                استدعاء الممرضات
                            </Link>
            ...
            <main id="main-content">
                ...
                <section className="relative min-h-[500px] flex items-center justify-center overflow-hidden">
                    <div className="absolute inset-0 z-0">
                        <Image
                            src="/photo/healthcare-nurse-call-products.webp"
                            alt="نظام استدعاء الممرضات للمستشفيات في مصر"
                            fill
                    ...
                    <div className="relative z-10 container mx-auto px-4 text-center text-white">
                        <h1 className="text-4xl md:text-6xl font-black mb-6 drop-shadow-xl tracking-tight leading-relaxed">
                            ...
                            <span className="text-red-500">للمستشفيات في مصر</span>
                        </h1>
                        <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto leading-relaxed font-medium text-gray-200 drop-shadow-lg">
                            Nurse Call System متطور يرفع مستوى الرعاية الصحية ويحسن سرعة الاستجابة لحالات المرضى
                        </p>
                        <a
                            href="https://api.whatsapp.com/send?phone=201227993999"
                            target="_blank"
                    ...
                    <div className="container mx-auto px-4 max-w-5xl">
                        <div className="prose prose-lg max-w-none text-right" dir="rtl">
                            <p className="text-xl text-gray-700 leading-relaxed mb-8">
                                يعتبر <strong>نظام استدعاء الممرضات (Nurse Call System)</strong> من الأنظمة الحيوية داخل المستشفيات
                                والمراكز الطبية. يهدف النظام إلى تسهيل التواصل بين المرضى وطاقم التمريض من خلال وحدات استدعاء
                                إلكترونية متصلة بلوحة مركزية أو شاشات عرض.
                            </p>
                            <p className="text-xl text-gray-700 leading-relaxed mb-8">
                                توفر أحدث حلول <strong>Nurse Call System Egypt</strong> المصممة لرفع مستوى
                                الرعاية الصحية وتحسين سرعة الاستجابة. في بيئة المستشفيات، كل ثانية مهمة؛ لذلك يساعد النظام على
                                تقليل زمن الاستجابة وتحسين مستوى الأمان داخل المنشأة الطبية بشكل ملحوظ.
                            </p>
                            <p className="text-xl text-gray-700 leading-relaxed mb-8">
                                يتميز النظام بقدرته على التكامل مع أنظمة المستشفى الأخرى، مما يتيح للطاقم الطبي متابعة دقيقة
                                لحالات المرضى وتحديد أولويات الاستجابة بكفاءة عالية. تقدم حلولاً مرنة تناسب جميع أحجام
                                المستشفيات والعيادات، مع دعم فني شامل وخدمة صيانة مستمرة.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-20 bg-gray-50">
                    <div className="container mx-auto px-4 max-w-6xl">
                        <h2 className="text-4xl font-black text-center mb-4 text-gray-900">مكونات نظام استدعاء الممرضات</h2>
                        <p className="text-center text-gray-600 mb-16 text-xl">أجهزة متكاملة لتغطية احتياجات المستشفى كاملاً</p>

                        <div className="grid md:grid-cols-2 gap-8">
                            {[
                                {
                                    title: "وحدة استدعاء بجانب سرير المريض",
                                    desc: "يضغط المريض على الزر فيصل النداء فوراً إلى غرفة التمريض المركزية والممرضة المسؤولة، مع تسجيل الوقت تلقائياً.",
                                    img: "/photo/nurse call systems.jpeg",
                                    alt: "وحدة استدعاء الممرضات بجانب السرير",
                                },
                                {
                                    title: "لوحة عرض مركزية",
                                    desc: "شاشة مركزية في محطة التمريض تُظهر رقم الغرفة والجناح ونوع النداء مع مؤشر الزمن المنقضي.",
                                    img: "/photo/healthcare-nurse-call-products.webp",
                                    alt: "لوحة عرض مركزية لنظام استدعاء الممرضات",
                                },
                                {
                                    title: "تنبيهات صوتية وضوئية",
                                    desc: "نظام تنبيه متعدد القنوات يشمل صفارات صوتية وإضاءة فلاشية بألوان مختلفة لتمييز درجة الطوارئ.",
                                    img: "/photo/digital-display-screens-products.webp",
                                    alt: "تنبيهات صوتية وضوئية لنظام استدعاء الممرضات",
                                },
                                {
                                    title: "نظام مراقبة مركزي",
                                    desc: "برنامج إدارة شامل يسجل جميع النداءات وأوقات الاستجابة ويصدر تقارير دورية لتحسين أداء الطاقم الطبي.",
                                    img: "/photo/queue-management-products-display.webp",
                                    alt: "نظام مراقبة مركزي للمستشفى",
                                },
                            ].map((item, i) => (
                                <div key={i} className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all overflow-hidden flex flex-col md:flex-row group">
                        ...
                        <div className="grid md:grid-cols-2 gap-16 items-center">
                            <div className="relative h-96 rounded-2xl overflow-hidden shadow-2xl order-2 md:order-1">
                                <Image
                                    ...
                                    alt="نظام استدعاء الممرضات في المستشفى"
                                    fill
                                    className="object-cover"
                                />
                            </div>
                            <div className="order-1 md:order-2">
                                <h2 className="text-4xl font-black mb-8 text-gray-900">
                                    فوائد <span className="text-red-600">Nurse Call System</span>
                                </h2>
                                <ul className="space-y-5">
                                    {[
                                        "سرعة استجابة عالية في حالات الطوارئ",
                                        "تحسين جودة رعاية المرضى بشكل ملموس",
                                        "تقليل الضغط النفسي على الطاقم الطبي",
                                        "متابعة دقيقة لحالات المرضى على مدار الساعة",
                                        "تسجيل تلقائي لأوقات النداء والاستجابة",
                                        "تقليل الأخطاء الطبية الناتجة عن التأخير",
                                        "تحسين رضا المرضى وذويهم عن مستوى الخدمة",
                                    ].map((benefit, i) => (
                ...
                <section className="py-20 bg-red-600 text-white">
                    <div className="container mx-auto px-4 max-w-5xl">
                        <div className="text-center mb-12">
                            <h2 className="text-4xl font-black mb-6">لماذا يعتبر النظام ضروريًا؟</h2>
                            <p className="text-xl leading-relaxed max-w-3xl mx-auto text-red-100">
                                في بيئة المستشفيات، كل ثانية مهمة. يساعد نظام استدعاء الممرضات على تقليل زمن الاستجابة وتحسين مستوى
                                الأمان داخل المنشأة الطبية، مما يُقلل من المضاعفات الصحية الناتجة عن التأخر في تقديم المساعدة.
                            </p>
                        </div>
                            ...
                            {[
                                {
                                    icon: "⚡",
                                    title: "استجابة فورية",
                                    desc: "يتلقى الطاقم النداء في ثوانٍ معدودة مع تحديد دقيق لموقع المريض",
                                },
                                {
                                    icon: "🏥",
                                    title: "بيئة آمنة",
                                    desc: "يُقلل من حوادث السقوط والتأخير في تلقي الرعاية الطارئة",
                                },
                                {
                                    icon: "📊",
                                    title: "إدارة فعّالة",
                                    desc: "تقارير تساعد الإدارة على تحسين توزيع الطاقم وتخطيط الوردات",
                                },
                            ].map((item, i) => (
                                <div key={i} className="bg-white/15 backdrop-blur-sm rounded-2xl p-8 text-center hover:bg-white/25 transition-all">
                ...
                <section className="py-20 bg-gray-50">
                    <div className="container mx-auto px-4 max-w-6xl">
                        ...
                        <p className="text-center text-gray-600 mb-16 text-xl">مشاريع حقيقية منفذة في مستشفيات مصر</p>
                        <div className="grid md:grid-cols-3 gap-6">
                            {[
                                { src: "/photo/healthcare-nurse-call-products.webp", alt: "منتجات نظام استدعاء الممرضات" },
                                { src: "/photo/nurse call systems.jpeg", alt: "تركيب نظام استدعاء الممرضات في المستشفى" },
                                { src: "/photo/modern-queue-management-system-display-in-hospital.webp", alt: "نظام إدارة المستشفى" },
                            ].map((img, i) => (
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mb-8">
                        <div>
                            ...
                            <ul className="text-gray-400 list-disc leading-relaxed space-y-1 pr-5">
                                ...
                                <li>خبرة في أنظمة الرعاية الصحية والتمريض</li>
